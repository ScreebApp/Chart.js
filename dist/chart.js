...
function pathRadiusLine(scale, radius, borderRadius, circular, labelCount) {
    ...
    if (circular) {
        ...
        ctx.lineTo((pointPosition1.x + pointPosition2.x) / 2, (pointPosition1.y + pointPosition2.y) / 2);
        for(let i = 1; i <= labelCount; i++){
            pointPosition1 = pointPosition2;
            pointPosition2 = scale.getPointPosition((i + 1) % labelCount, radius);
            ctx.arcTo(pointPosition1.x, pointPosition1.y, (pointPosition1.x + pointPosition2.x) / 2, (pointPosition1.y + pointPosition2.y) / 2, borderRadius);
        }
    } else {
